	...
	<div class="containera">
		...
		<div class="table">
			...
			<div class="table-header">
				<div class="header__item" id="name" class="filter__link" >Name</div>
				<div class="header__item" id="wins" class="filter__link filter__link--number" >ID</div>
				<div class="header__item" id="draws" class="filter__link filter__link--number" >Email</div>
			</div>
            ...
            <?php
                ...
                while($us = mysqli_fetch_array($user))
                {
                    ...
                    <div class='table-row'>
                    <div class='table-data'>$us[name]</div>
                        <div class='table-data'>$us[id]</div>
                        <div class='table-data'>$us[email]</div>
                    </div><hr>
                </div>";
                }
            ?>
