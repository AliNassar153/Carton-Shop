...
<body>
   ...
   if(isset($message)){
      foreach($message as $message){
         echo '<div style="color: green;" class="message" onclick="this.remove();">'.$message.'</div>';
      }
   }
   ?>
   ...
   <div class="products">
      ...
      ?>
         <form method="post" class="box" style="width: 250px;" action="">
   ...
   <div style=" border: 2px solid #3498db;" class="user-profile">
             <p> Pay now</p>
        <div class="flex">
            <a style="color: white;" class="btn" href="payment.php"> Pay</a>           
        </div>
  </div>

   <div style=" border: 2px solid #e74c3c; margin-top:60px;" class="user-profile">
   ...
   <p> Active user : <span><?php echo $fetch_user['name']; ?></span> </p>
   <div class="flex">
